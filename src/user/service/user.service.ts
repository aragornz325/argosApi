...
export class UserService {
    ...
    try {
        ...
        const hashedPassword = bcrypt.hashSync(body.password, parseInt(config().bcrypt.salt));
        ...
        throw new InternalServerErrorException('Error: ' + error.message, 'code: ' + error.code);
    }
    }
    ...
    try {
       ...
       return this.userRepository.merge(user, {...body, updatedAt: new Date()});
